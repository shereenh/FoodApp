package com.restaurant.foodapp.view.view.decorator
...
class DotPagerIndicator : RecyclerView.ItemDecoration() {

    private val colorActive = -0x373738
    private val colorInactive = -0x1f1f20
